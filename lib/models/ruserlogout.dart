...
RUserLogOut disposisismFromJson(String str) =>
    RUserLogOut.fromJson(json.decode(str));

String disposisismToJson(RUserLogOut _data) => json.encode(_data.toJson());
...
class RUserLogOut {
  ...
  RUserLogOut.fromJson(Map<dynamic, dynamic> json){
