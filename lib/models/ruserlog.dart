...
RUserLog disposisismFromJson(String str) =>
    RUserLog.fromJson(json.decode(str));

String disposisismToJson(RUserLog _data) => json.encode(_data.toJson());
...
class RUserLog {
  ...
  RUserLog.fromJson(Map<dynamic, dynamic> json){
    id = json['id'];
    nip = json['nip'];
    nik = json['nik'];
    name = json['name'];
