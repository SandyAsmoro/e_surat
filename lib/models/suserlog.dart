...
SUserLog disposisismFromJson(String str) =>
    SUserLog.fromJson(json.decode(str));

String disposisismToJson(SUserLog _data) => json.encode(_data.toJson());
...
class SUserLog {
  ...
  SUserLog.fromJson(Map<dynamic, dynamic> json){
    id = json['id'];
    nip = json['nip'];
    nik = json['nik'];
    name = json['name'];
